...
root.resizable(0, 0)
# label
label=ttk.Label(root, text="URL Shortener", foreground="blue",font=('Comic Sans MS', 20,"bold"))
label.grid(row=0)
# label for input URL
url_input=ttk.Label(root, text="Enter URL: ",font=("Comic Sans MS",10,"bold"))
...
shortened_url_label=ttk.Label(root, text="Shortened Url: ",font=("Comic Sans MS",10,"bold"))
